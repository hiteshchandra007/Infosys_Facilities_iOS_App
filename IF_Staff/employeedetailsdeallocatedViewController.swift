//
//  employeedetailsdeallocatedViewController.swift
//  JDBCiOS
//
...
class employeedetailsdeallocatedViewController: UIViewController, NSURLConnectionDataDelegate {
    var flag = 0
    var serverData:Data?
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if flag == 1{
            for i in recArray!{
                ...
                print("WOW")
                if detailsofdeallocatedViewController.selectedUserid == gd.value(forKey: "userid") as! String{
