//
//  allocaterequestdetailasViewController.swift
//  JDBCiOS
//
...
class allocaterequestdetailasViewController: UIViewController , NSURLConnectionDataDelegate{
    var flag = 0
    var serverData:Data?
        ...
        if flag == 1 {
            ...
            for i in recArray!{
                ...
                if requiredreqid == gd.value(forKey: "reqid") as! String{
                    print("WOW")
                    allocaterequestdetailasViewController.selectedUserid = gd.value(forKey: "userid") as! String
