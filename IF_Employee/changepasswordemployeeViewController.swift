//
//  changepasswordemployeeViewController.swift
//  IF_Employee
//
...
class changepasswordemployeeViewController: UIViewController, NSURLConnectionDataDelegate {
    var flag = 0
    var serverData:Data?
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if flag == 1{
            for i in recArray!{
                ...
                if gd.value(forKey: "userid") as! String == AdminViewController.EmployeeId{
                    print("enter3")
    ...
    @IBAction func saveAction(_ sender: UIButton) {
        ...
        for i in gd {
            ...
            if usernameOutlet.text == AdminViewController.usercredential && oldPasswordOutlet.text == p.value(forKey: "password") as! String && usernameOutlet.text == p.value(forKey: "userid") as! String {
                print("entered")
                print(validatepassword(password: newPasswordOutlet.text!))
                if (newPasswordOutlet != oldPasswordOutlet && validatepassword(password: newPasswordOutlet.text!)) && captchaEnteredOutlet.text == showCaptchaOutlet.text{
                    ...
                    print("passwordcouldnotbechanged")
                     alert(msg: "Invalid Credential", info: "Password has not been changed", vc: self)
                }
            }
        }
    }
